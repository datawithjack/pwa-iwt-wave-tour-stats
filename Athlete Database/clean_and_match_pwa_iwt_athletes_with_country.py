...
# Step 1: Add alt_iwt_id for Paco Stuven
merged_df['alt_iwt_id'] = None
merged_df.loc[(merged_df['iwt_name'] == 'Paco Stuven') & (merged_df['iwt_id'] == 1437350), 'alt_iwt_id'] = 566400

# Step 2: Drop duplicate rows
merged_df = merged_df.drop_duplicates().reset_index(drop=True)

# drop old iwt_ids
ids_to_drop = [566400, 923495, 532107]
merged_df = merged_df[~merged_df['iwt_id'].isin(ids_to_drop)].reset_index(drop=True)


# Step 4: Add alt_iwt_id for other matched names
merged_df.loc[
    (merged_df['iwt_name'] == 'Jahdan Tyger') & (merged_df['iwt_id'] == 1541677),
    'alt_iwt_id'
] = 923495

merged_df.loc[
    (merged_df['iwt_name'] == 'Masahiro Yoshitake') & (merged_df['iwt_id'] == 1539826),
    'alt_iwt_id'
] = 532107
